...
## Task
Danny started a pizza business and would like to answer questions regarding: 
- Pizza Metrics
- Runner and Customer Experience
- Ingredient Optimisation
- Pricing and Ratings.

The full problem statement can be found [here](https://8weeksqlchallenge.com/case-study-2/).
